...
module.exports = Bone => {
  return class Spine extends Bone {
    ...
    /**
     * dataValues, request ctx or other config those developer mounted on Model should not be serialized
     * @param {Array<string>} [exceptKeys=[]] [ 'ctx', 'config' ]
     * @returns {Object}
     */
    toJSON(exceptKeys = []) {
      return super.toJSON([ 'dataValues' ].concat(exceptKeys));
    }
     ...
     */
    toObject(exceptKeys = []) {
      return super.toObject([ 'dataValues' ].concat(exceptKeys));
    }
