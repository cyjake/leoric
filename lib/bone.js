...
class Bone {
  ...
  static async bulkCreate(records, options = {}) {
    ...
    // unalias first
    if (Array.isArray(opts.updateOnDuplicate)) opts.updateOnDuplicate = opts.updateOnDuplicate.map((field) => this.unalias(field));
    if (Array.isArray(opts.uniqueKeys)) opts.uniqueKeys = opts.uniqueKeys.map((field) => this.unalias(field));
