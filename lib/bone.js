...
class Bone {
  ...
  static init(attributes, opts = {}) {
    ...
    const primaryKeyName = Object.keys(attributes).find(key => attributes[key].primaryKey);
    if (primaryKeyName && primaryKeyName !== this.primaryKey) {
    ...
    if (!attributes[this.primaryKey] && !Object.values(attributes).find(arr => arr.primaryKey)) {
