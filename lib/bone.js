...
class Bone {
  ...
  toJSON() {
    ...
    const attributeNames = Object.keys(this.constructor.attributes);
    for (const key of propertyNames) {
      if (attributeNames.includes(key) && this.rawUnset.has(key)) continue;
  ...
  static renameAttribute(originalName, newName) {
    ...
    if (attributes.hasOwnProperty(originalName)) {
      ...
      delete this.prototype[originalName];
